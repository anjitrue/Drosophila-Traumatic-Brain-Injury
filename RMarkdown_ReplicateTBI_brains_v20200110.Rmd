...
legend("topright", 
       ...
       pch = 16, 
       col = colors[3:5][1:length(levels(factor(mean_normaized_FW_byProtein_sepTBIandCTRL$replicates)))], 
       y.intersp = 0.7)

# sample.colors = as.numeric(factor(mean_normaized_FW_byProtein_sepTBIandCTRL$hour))
# par(mar=c(6.5, 7.5, 4.5, 1))
# plot(pca_FW_meanNormalized$x, pch = 19, cex = 2,
#      col = colors[sample.colors], 
#      main = "Principle Component Analysis\n Brain TBI Normalized to Mean Protein Intensity\n on Food & Water", 
...
#        legend = levels(factor(mean_normaized_FW_byProtein_sepTBIandCTRL$replicates)), 
#        pch = 16, 
#        col = colors[1:length(levels(factor(mean_normaized_FW_byProtein_sepTBIandCTRL$replicates)))], 
#        y.intersp = 0.7)
