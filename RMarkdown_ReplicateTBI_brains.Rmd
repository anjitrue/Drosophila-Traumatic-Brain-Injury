...
load("C:/Users/etrujillo2/Documents/Projects/.Rproj.user/Drosophila-Traumatic-Brain-Injury/ReplicteTBI_brains_formatted.Rdata")
...
# s = std_time.point_lessThan100CV[,-1]
...
timeSeries_protein_plot <- function(n,x,s){
  ...
  even_std_timepoints_minus <- c(even_timepoints[1], even_timepoints[2:length(even_timepoints)]-(even_std_timepoints))
  
  even_std_timepoints_plus <- c(even_timepoints[1], even_timepoints[2:length(even_timepoints)]+(even_std_timepoints))
  
  odd_std_timepoints_minus <- c(odd_timepoints[1], odd_timepoints[2:length(odd_timepoints)]-(odd_std_timepoints))
  
  odd_std_timepoints_plus <- c(odd_timepoints[1], odd_timepoints[2:length(odd_timepoints)]+(odd_std_timepoints))
...
n <- protein_id
timeSeries_protein_plot(n,average_time.point_lessThan100CV[,-1],std_time.point_lessThan100CV[,-1])
